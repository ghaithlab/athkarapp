...
List paragraphSleeping = [
  ...
  {
    "paragraph":
        "اللهـم إنـك خلـقت نفسـي وأنـت تَوَفّـاهـا لك ممـاتـها ومحـياها، إن أحييـتها فاحفظـها، وإن أمتـها فاغفـر لـها. اللهـم إنـي أسـألـك العـافـية.",
    "Counter": 1
  },
  {"paragraph": "اللهـم قنـي عذابـك يـوم تبـعث عبـادك.", "Counter": 3},
  {"paragraph": "باسـمك اللهـم أمـوت وأحـيا.", "Counter": 1},
  {
    "paragraph":
